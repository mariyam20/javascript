...
class Person {#
    ...
    setPersonName(value) {
            // Requirement 1: this.personName can`t be null or undefined
            if (value == null || value == undefined) {
                console.error("Null or4 undefined is not allowed for personName");
            } else {
                if (value.length >= 30) {
                    console.error("personName lenght can't be more then 30 characters.")
                } else {
...
person1.setAge(40); //age property wil be assigned to 40 
console.log(person1.getPersonName()); //the get method returns the value "John"
